...
#define MSP_CMD_FC_VARIANT_BYTE     0x02 // 2   //out message - FC variant
#define MSP_CMD_VTX_CONFIG_BYTE     0x58 // 88  //out message - ft vtx settings
#define MSP_CMD_SET_VTX_CONFIG_BYTE 0x59 // 89  // in message - Set vtx settings - betaflight
#define MSP_CMD_STATUS_BYTE         0x65 // 101 //out message - cycletime & errors_count & sensor present & box activation & current setting number
#define MSP_CMD_RC_BYTE             0x69 // 105 //out message - rc channels and more
#define MSP_CMD_DISPLAYPORT_BYTE    0xB6 // 182 // in message
#define MSP_CMD_SET_OSD_CANVAS_BYTE 0xBC // 188 // in message - osd canvas size COLSxROWS
